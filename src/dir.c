/*
    ...
    forked from AROS workbench/c/Dir.c; ACE-specific changes are marked below.
*/

#define MAX_PATH_LEN                    512

#define USE_SOFTLINKCHECK               0
/* ACE-specific: preserve symlink entries while making recursive Dir safe. */
...
)
{
    ...
    if (error != RETURN_OK)
    {
        ...
        case ERROR_NO_MORE_ENTRIES:
            ...
            break;
        case ERROR_BREAK:
            /* Ctrl-C is a normal cooperative exit, not a failure to examine
