#ifndef AMIGA_SHELL_LIBRARIES_IFFPARSE_H
#define AMIGA_SHELL_LIBRARIES_IFFPARSE_H
...
#define IFFF_RESERVED 0xFFFF0000UL
...
#define MAKE_ID(a, b, c, d) \
    ((((ULONG)(UBYTE)(a)) << 24) | (((ULONG)(UBYTE)(b)) << 16) | \
     (((ULONG)(UBYTE)(c)) << 8) | ((ULONG)(UBYTE)(d)))
#endif
