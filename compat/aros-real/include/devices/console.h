...
/*
 * This is rom/devs/console/include/console.h verbatim -- real, portable
 * AROS source that, like conunit.h beside it, lives next to console.device
 * rather than in compiler/include, so an ordinary -I of the public include
 * tree does not reach it. See devices/conunit.h's own header comment.
 */
